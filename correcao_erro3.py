#Solução na linha 78
#Chatgpt parece ter um problema com as variaveis locais. De novo ele chamou uma variavel dentro de uma função e não a definiu como global
        ...
        for evento in pygame.event.get():
            if evento.type == pygame.QUIT:
                ...
                if tabuleiro[linha][coluna] == '':
                    global jogador_atual #Definir a variável jogador_atual como global
